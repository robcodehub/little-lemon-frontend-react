...
const Footer = () => {
  return (
    <footer className="bg-yellow-300 py-6">
      <div className="container mx-auto px-4 md:flex md:gap-4 md:justify-between w-full">
        {/* For mobile and desktop */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:flex md:justify-start md:items-start">
          {/* Image Column - hidden on mobile */}
          <div className="hidden md:block md:col-span-1 md:w-1/4">
            <img src="/img/littlelemonrestaurant.jpg" alt="Restaurant" className="rounded-3xl" />
          </div>

          {/* Navigation Column */}
          <div className="flex flex-col items-center md:col-span-1 md:w-1/4">
            <h4 className="font-bold mb-2 text-gray-800">Navigation</h4>
            <Link href="/" className="text-gray-800 hover:text-yellow-600">Home</Link>
            <a href="#about" className="text-gray-800 hover:text-yellow-600">About</a>
            <a href="#menu" className="text-gray-800 hover:text-yellow-600">Menu</a>
